...
public class LindoGenerator {
	...
	public String generateLindoCode(Model model) {
		...
		// Maximum debris constraint
		result += maxDebrisConstraint(model) + "\n";
	...
	private String debrisConstraintLHS(Model model) {
		String result = "";
	...
	private String minDebrisConstraint(Model model) {
		return debrisConstraintLHS(model) + " >= " + numberString(model.minDebrisPerYear * model.years);
	}
	
	private String maxDebrisConstraint(Model model) {
		return debrisConstraintLHS(model) + " <= " + numberString(model.maxDebrisPerYear * model.years);
	}
